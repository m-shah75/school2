                ...
                <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                    <li class="nav-item sidebar-nav-item">
                        <a href="#" class="nav-link"><i
                                class="flaticon-multiple-users-silhouette"></i><span>معلمان</span></a>
                        <ul class="nav sub-group-menu">
                            <li class="nav-item">
                                <a href="teacher-class.html" class="nav-link"><i class="fas fa-angle-right"></i>کلاس ها</a>
                            </li>
                            <li class="nav-item">
                                <a href="teacher-attendance.html" class="nav-link"><i
                                        class="fas fa-angle-right"></i>لیست حضوری</a>
                            </li>
                            <li class="nav-item">
                                <a href="add-book.html" class="nav-link"><i class="fas fa-angle-right"></i>جزوات و کتاب ها</a>
                            </li>
                            <li class="nav-item">
                                <a href="teacher-exam.html" class="nav-link"><i
                                        class="fas fa-angle-right"></i>امتحانات</a>
                            </li>
                        </ul>
                    </li>
                </ul>
