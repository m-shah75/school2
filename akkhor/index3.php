                        ...
                        <div class="card-body">
                            ...
                            <div class="student-info">
                                <div class="media media-none--xs">
                                    <div class="item-img">
                                        <img src="img/figure/student1.png" class="media-img-auto" alt="student">
                                    </div>
                                    <div class="media-body">
                                        <h3 class="item-title">سنترال فایل</h3>
                                ...
                                <div class="table-responsive info-table">
                                    <table class="table text-nowrap">
                                        ...
                                        <tr>
                                            <td>نام:</td>
                                            <td class="font-medium text-dark-medium">سنترال فایل</td>
                                        </tr>
                                        <tr>
                                            <td>جنسیت:</td>
                                            <td class="font-medium text-dark-medium">زن</td>
                                        </tr>
                                        <tr>
                                            <td>نام پدر:</td>
                                            <td class="font-medium text-dark-medium">سنترال فایل</td>
                                        ...
                                        <tr>
                                            <td>دین:</td>
                                            <td class="font-medium text-dark-medium">اسلام</td>
                                        </tr>
                                        <tr>
                                            <td>شغل پدر:</td>
                                            <td class="font-medium text-dark-medium">طراح گرافیک</td>
                                        </tr>
                                        <tr>
                                            <td>ایمیل:</td>
                                        ...
                                        <tr>
                                            <td>بخش:</td>
                                            <td class="font-medium text-dark-medium">صورتی</td>
                                        </tr>
                                        <tr>
                                            <td>رول:</td>
                                        ...
                                        <tr>
                                            <td>آدرس:</td>
                                            <td class="font-medium text-dark-medium">خانه شماره 10، جاده 6، استرالیا</td>
                                        </tr>
                                        <tr>
                                            <td>تلفن:</td>
                                        ...
                                        <form class="search-form-box">
                                            <div class="row gutters-8">
                                                <div class="col-lg-4 col-12 form-group">
                                                    <input type="text" placeholder="جستجو توسط امتحان ..."
                                                           class="form-control">
                                                </div>
                                                <div class="col-lg-3 col-12 form-group">
                                                    <input type="text" placeholder="جستجو توسط موضوع ..."
                                                           class="form-control">
                                                </div>
                                                <div class="col-lg-3 col-12 form-group">
                        ...
                        <div class="card-body">
                            ...
                            <div class="student-report">
                                <div class="student-count pseudo-bg-blue">
                                    <h4 class="item-title">غایب</h4>
                                    <div class="item-number">28.2%</div>
                                </div>
                                <div class="student-count pseudo-bg-yellow">
                                    <h4 class="item-title">حاضر</h4>
